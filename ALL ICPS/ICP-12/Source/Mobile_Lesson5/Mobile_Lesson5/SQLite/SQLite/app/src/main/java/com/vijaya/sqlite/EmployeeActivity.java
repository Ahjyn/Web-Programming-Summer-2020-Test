...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void saveToDB() {
        ...
        try {
            ...
            c.setTime((new SimpleDateFormat("dd/MM/yyyy")).parse(
            ...
            d = c.getTimeInMillis();
            values.put(SampleDBContract.Employee.COLUMN_EMPLOYED_DATE, d);
        } catch (Exception e) {
            Log.e(TAG, "Error", e);
    ...
    private void readFromDB() {
        String fn = binding.firstnameEditText.getText().toString();
        String ln = binding.lastnameEditText.getText().toString();

        SQLiteDatabase database = new SampleDBSQLiteHelper(this).getReadableDatabase();

        String[] selectionArgs = {"%" + fn + "%", "%" + ln + "%"};
    ...
    private void update() {
        ...
        String f = SampleDBContract.Employee.COLUMN_LASTNAME+"='"+ ln +"'";
        database.update(SampleDBContract.Employee.TABLE_NAME,values , f,null);
    ...
    private void delete() {
        String ln = binding.lastnameEditText.getText().toString();
        SQLiteDatabase base = new SampleDBSQLiteHelper(this).getWritableDatabase();
        //fill this method to delete the row
        base.delete(SampleDBContract.Employee.TABLE_NAME, SampleDBContract.Employee.COLUMN_LASTNAME
                +"='"+ ln +"'", null);
